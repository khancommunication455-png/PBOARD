...
interface PresetDao {
    ...
    fun getById(id: Long): PresetEntity?

    @Query("SELECT * FROM sk_preset WHERE name = :name LIMIT 1")
    fun getByName(name: String): PresetEntity?

    @Insert(onConflict = OnConflictStrategy.REPLACE)
    fun insert(entity: PresetEntity): Long

    @Update
    fun update(entity: PresetEntity)

    @Delete
    fun delete(entity: PresetEntity)
