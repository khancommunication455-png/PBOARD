...
abstract class StyleKitDatabase : RoomDatabase() {
    companion object {
                            ...
                            override fun onCreate(db: SupportSQLiteDatabase) {
                                ...
                                db.execSQL(
                                    ...
                                    INSERT INTO sk_config (id, theme_id, key_shape, background_media_uri,
                                        ...
                                        haptics_enabled, active_preset_id, live_preset_enabled,
                                        emoji_shortcuts_enabled)
                                    VALUES (1, 'charcoal', 'square', '', 0.55, 0, ${0xFF06E6FF}, 2200, 0.35,
                                        'mechanical', 0.6, 0, '', 1, 0, 0, 1)
                                    """.trimIndent()
                                )
                            }
                        })
        ...
        // Explicit migrations are listed here as the schema evolves. v1 is the initial release.
        private val ALL_MIGRATIONS: Array<Migration> = arrayOf(
            // Add Migration(N, N+1) instances as the schema grows.
        )
    }
