...
fun PresetsScreen() {
    ...
    var activePresetId by remember { mutableStateOf(0L) }
    ...
    val activePreset = presets.firstOrNull { it.rowId == activePresetId } ?: presets.firstOrNull()
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Row(
                        ...
                        presets.forEach { preset ->
                            AssistChip(
                                onClick = { activePresetId = preset.rowId },
                                label = { Text(preset.name) },
                                colors = if (activePresetId == preset.rowId) {
